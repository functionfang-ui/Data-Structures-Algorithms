...
QString currentPath = "C:/Users/fang/Desktop/to do list/on/Qt/towerdefense/towerdefense/TowerDefenseQt";
static const QString s_curDir = currentPath + "/";
...
void AudioPlayer::playSound(SoundType soundType)
{
	static const QUrl mediasUrls[] =
	{
        ...
        QUrl::fromLocalFile(s_curDir + "music/arrow_shoot.wav"),
